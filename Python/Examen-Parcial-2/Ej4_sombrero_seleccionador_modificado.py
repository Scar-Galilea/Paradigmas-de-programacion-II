...
Gryffindor = ("Ordinario.","Te extraña, pero sonríe.","Gloria."," Valiente.","La fuerza.","Invisibilidad")
Slytherin = ("Ignorante.","Pide más historias sobre tus aventuras.","Sabiduría.","Ambicioso.","La astucia.","Dormir")
Hufflepuff = ("Cobarde.","Piensa con admiración tus logros.","Amor.","Leal","La paciencia.","Superfuerza")
Ravenclaw = ("Egoísta.","No me importa lo que piensen de mí después de mi muerte, lo que piensen de mí ahora es lo que cuenta.","Poder.","Curioso.","La inteligencia.","Teletrasportarse")
...
Conjunto_6 = {Gryffindor[5],Slytherin[5],Hufflepuff[5],Ravenclaw[5]}

Respuesta = [Conjunto_1,Conjunto_2,Conjunto_3,Conjunto_4,Conjunto_5,Conjunto_6]

#Lista de preguntas.
Preguntas = ['a) ¿Cuál de las siguientes opciones odiarías más que la gente te llamara?','b) Después de tu muerte ¿qué es lo que más le gustaría que hiciera la gente cuando escuche su nombre?','c)Dada la opción, preferirías inventar una poción que garantizara','d) ¿Cómo te definirías en una sola palabra?','e)¿Qué cualidad te describe mejor?','f)Superpoder favorito']
